...
namespace Buddy
{
    class Config : IConfig
    {
        ...
        [Description("Should a hint be sent be sent telling players who their buddy is..")]
        public bool SendBuddyHint { get; set; } = true;

        [Description("Should a hint be sent be sent to a player when someone requests to be their buddy.")]
        public bool SendBuddyRequestHint { get; set; } = true;

        [Description("Should a hint be sent be sent telling players that their buddy request was accepted.")]
        public bool SendBuddyAcceptedHint { get; set; } = true;
